...
*/}
        ...
        <h3>Notes:</h3>
          ...
          <ol>
            <li>
              This would show for like ~10 seconds and then auto move to the
              input screen again.
            </li>
            <li>
              The red text items to be updated only would show if there were
              items that were unchecked in the flow.
            </li>
          </ol>
